...
from ops_deck_rag.retrieval import retrieve_context
...
When metric context is present, prioritize those extracted chart/table values over surrounding prose.
""".strip()
...
def ask(question: str, month: str | None = None, business_unit: str | None = None, k: int = 5) -> str:
    ...
    context = retrieval_context.text[: settings.max_context_chars]
